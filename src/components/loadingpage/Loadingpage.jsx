...
const Loadingpage = ({ isDarkMode }) => {
  return (
    <div className={`w-screen h-screen flex items-center justify-center ${
      ...
      <img className='w-50 h-auto object-cover absolute top-[35%] right-[38%] bg:top-[35%] bg:right-[38%] z-30' src={process.env.PUBLIC_URL + `/assets/images/loading-image-1.svg`} alt='' />
      ...
      <img className='w-40 h-auto object-cover absolute top-[27%] left-[36%] bg:top-[30%] bg:right-[35%] z-20' src={process.env.PUBLIC_URL + `/assets/images/loading-image-3.svg`} alt='' />
